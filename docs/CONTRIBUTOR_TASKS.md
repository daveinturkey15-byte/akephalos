...
- [Test Akephalos with Cline or Roo Code MCP clients](https://github.com/sunnja69/akephalos/issues/16) — start with the [VS Code MCP Client Notes](VS_CODE_MCP_CLIENT_NOTES.md).
