...
Use the [VS Code MCP Client Notes](VS_CODE_MCP_CLIENT_NOTES.md) to capture the exact settings path, resource/tool behavior, and status wording without overclaiming support. Cline/Roo testers can use the focused [Cline/Roo MCP Client Notes](CLINE_ROO_MCP_CLIENT_NOTES.md) for issue #16.
