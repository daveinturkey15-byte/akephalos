...
- Cursor, Claude Desktop, Cline/Roo Code, or opencode using `node dist/index.js mcp` as a local stdio MCP server, with the [MCP Client Smoke-Test Worksheet](../../docs/MCP_CLIENT_SMOKE_WORKSHEET.md). Cursor/Cline/Roo testers can start with the narrower [VS Code MCP Client Notes](../../docs/VS_CODE_MCP_CLIENT_NOTES.md).
